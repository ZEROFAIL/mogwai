...
class GraphRelationshipVertexIOTestCase(BaseMogwaiTestCase):
    ...
    def test_follow_through(self):
        ...
        v1 = yield self.vertex_model.create(name='test relationship')
        e1, v2 = yield v1.relation.create(vertex_params={'name': 'new relation'})
        try:
    ...
    def test_relationship_isolation(self):
        ...
        e1, v12 = yield v11.relation.create(vertex_params={'name': 'new_relation_1'})
        v21 = yield self.vertex_model.create(name='test2')
        e2, v22 = yield v21.relation.create(vertex_params={'name': 'new_relation_2'})
        try:
